...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', type=str, help='path of the extracted image.')
    ...
    parser.add_argument('-i', '--image_txt', default='input_txt', help='image names')

    parser.add_argument('-d', '--data_dir', default='/home/s2254720/data/CUB_200_2011',help='folder with data' )
    ...
    image_batch, image_pil = extractor.preprocess(img_name, args.load_size)
    descs = extractor.extract_descriptors(image_batch.to(device), features, args.facet, args.bin)
    feat = []
