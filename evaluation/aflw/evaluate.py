...
def run(datapath, split, benchmark, featurepath, thres, alpha, logpath, layers, w, model_type, model, transform, visualize=False):
    ...
    dset = aflw.AFLWDataset(datapath, thres, device, split)
    ...
    for idx, data in enumerate(dataloader):
        ...
        src_img_path = os.path.join(datapath, data['src_imname'][0])
        trg_img_path = os.path.join(datapath,data['trg_imname'][0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/s2254720/data/aflw/MTFL')
    parser.add_argument('--featurepath', type=str, default='/data1/aflw/features_resnet50/')
    parser.add_argument('--benchmark', type=str, default='aflw')
    parser.add_argument('--thres', type=str, default='img', choices=['auto', 'img', 'bbox'])
