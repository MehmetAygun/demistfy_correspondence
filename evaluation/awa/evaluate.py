...
def run(datapath, split, benchmark, featurepath, thres, alpha, logpath, layers, w, model_type, model, transform, visualize=False):
    ...
    dset = awa.AWADataset(datapath, thres, device, split)
    ...
    for idx, data in enumerate(dataloader):
        ...
        src_img_path = os.path.join(datapath, 'JPEGImages', data['src_imname'][0])
        trg_img_path = os.path.join(datapath, 'JPEGImages', data['trg_imname'][0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/s2254720/data/Awa2')
    parser.add_argument('--featurepath', type=str, default='/data1/Awa2/features_resnet50/')
    parser.add_argument('--benchmark', type=str, default='awa')
