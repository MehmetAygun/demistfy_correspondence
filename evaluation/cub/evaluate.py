...
def run(datapath, split, benchmark, featurepath, thres, alpha, logpath, layers, w, model_type, model, transform, visualize=False):
    ...
    dset = cub.CUBDataset(datapath, thres, device, split)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/s2254720/data/CUB_200_2011')
    parser.add_argument('--featurepath', type=str, default='/data1/CUB_200_2011/features_resnet50/')
